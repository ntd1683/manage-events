		...
		<div class="login">
			...
			<div class="login-content">
				<form action="index.html" method="POST" name="login_form">
					...
					{{ __('Forgot password? Need help remembering? You can request a reminder be sent to your linked email here.')}}
					</div>
					<div class="mb-3">
					...
					<button type="submit" class="btn btn-outline-theme btn-lg d-block w-100 fw-500 mb-3">{{ __('→')}}</button>
				</form>
			</div>
			<!-- END login-content -->
		</div>
